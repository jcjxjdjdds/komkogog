...
buttons_ques = [
    [
        InlineKeyboardButton("بـايـروجــرام ", callback_data="pyrogram"),
        InlineKeyboardButton("تـــليثـون ", callback_data="telethon"),
    ],
    [
        InlineKeyboardButton("بـايـروجــرام  ʙᴏᴛ", callback_data="pyrogram_bot"),
        InlineKeyboardButton("تـــليثـون  ʙᴏᴛ", callback_data="telethon_bot"),
    ],
]
...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @StringFatherBot\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ 🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @NO_VP8 🥺"
    try:
        if not is_bot:
